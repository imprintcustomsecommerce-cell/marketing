...
class NotificationCenter
{
    ...
    public function for(User $user): Collection
    {
        ...
        if ($user->team === User::TEAM_MULTIMEDIA) {
            ...
            $this->add($items, Coverage::where('stage', CoverageDesk::REQUESTED)->count(), 'Coverage requests', 'Marketing is waiting for Multimedia to respond.', route('admin.coverage.index', ['show' => 'requested']), 'warn');
